      ...
      <section className="py-16 bg-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-8 items-center group cursor-pointer">
              <div className="flex-1 relative aspect-[16/10] rounded-2xl overflow-hidden shadow-lg w-full">
                <Image
