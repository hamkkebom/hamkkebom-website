    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="container relative z-10 px-4 md:px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <span className="text-brand-400 font-bold tracking-wider uppercase">
              지속가능한 가치
            </span>
            ...
            <p className="text-lg text-ink-100 leading-relaxed max-w-xl">
             ...
             <ul className="space-y-4">
                <li className="flex items-start gap-4">
                   ...
                   <div>
                      ...
                      <p className="text-sm text-ink-200 mt-1">고객과의 약속을 생명처럼 여기며, 정직과 신뢰를 바탕으로 일합니다.</p>
                   </div>
                </li>
                <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-brand-300 mt-2" />
                   <div>
                      <h4 className="text-white font-medium">창의적 혁신</h4>
                      <p className="text-sm text-ink-300 mt-1">끊임없는 배움과 도전으로 기존의 틀을 깨는 혁신적인 솔루션을 제공합니다.</p>
                   </div>
                </li>
                 <li className="flex items-start gap-4">
                   <div className="w-2 h-2 rounded-full bg-brand-300 mt-2" />
                   <div>
                      ...
                      <p className="text-sm text-ink-300 mt-1">우리의 재능과 수익을 사회에 환원하여 더 따뜻한 세상을 만듭니다.</p>
                   </div>
                </li>
             </ul>
          </motion.div>
